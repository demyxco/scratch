...
# Default variables
DEMYX_OPCACHE="${DEMYX_OPCACHE:-true}"
CODE_XDEBUG="$(/usr/bin/find /usr/local/lib/php/extensions -name "xdebug.so")"
...
php_admin_value[error_log]  = /var/log/demyx/${DEMYX_DOMAIN}.error.log
